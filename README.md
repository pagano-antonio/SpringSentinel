...
Singleton Thread Safety (Lombok-aware): Detects mutable state in Singleton beans. v1.2.0 Update: Now ignores fields when Lombok's @FieldDefaults(makeFinal = true) is present, preventing false positives.
